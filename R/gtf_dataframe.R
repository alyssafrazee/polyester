...
#' row corresponds to an exon / coding sequence / start codon / stop codon, and the columns 
#' correspond to standard GTF columns denoting annotated genomic features. See  
